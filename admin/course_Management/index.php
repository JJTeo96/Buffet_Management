			...
			<?php
				...
				while($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td>
							<a href="#edit<?php echo $row['courseID']; ?>" data-toggle="modal" class="btn btn-warning"> Edit</a> || 
							<a href="#del<?php echo $row['courseID']; ?>" data-toggle="modal" class="btn btn-danger"> Delete</a> ||
                            <a href="#view<?php echo $row['courseID']; ?>" data-toggle="modal" class="btn btn-info"> View</a>
