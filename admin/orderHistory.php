		...
		<table class="table table-striped table-bordered table-hover" id="table_id">
			...
			?>
					<tr>
						...
						<td>
            <a href="../user/invoice.php?userID=<?php echo $row['userID']; ?>&invoiceID=<?php echo $row['invoice_id']; ?>" class="btn btn-warning"> Invoice</a> || 
            <a href="../user/deliveryOrder.php?userID=<?php echo $row['userID']; ?>&invoiceID=<?php echo $row['invoice_id'];; ?>" class="btn btn-danger"> Delivery Order</a>	
					</tr>
					<?php
				}
